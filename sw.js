...
assets/
  places.json      Real AlUla data (19 places + 14 services)
...
`assets/places.json` holds real AlUla data:
...
- **14 services** — Experience AlUla, HungerStation, Careem, Booking.com, stc, Mobily, Zain, Google Maps, etc.
...
The app uses elegant gradient placeholders by default. To add real images:
- Put photos in `assets/photos/` (e.g. `hegra.jpg`) and reference them by place id.
- Put service logos in `assets/logos/`.
- Use only images you own (RCU archive / your own) or open-licensed (Wikimedia). Do not use copyrighted images or brand logos without permission.
